<template>
  <div class="drawer-container">
    <div>
      ...
      <div class="drawer-item">
        <span>{{ $t('settings.dialogStyle') }}</span>
        <el-radio-group v-model="dialogStyle">
          <el-radio :label="1">{{ $t('settings.dialog.dialog') }}</el-radio>
          <el-radio :label="2">{{ $t('settings.dialog.drawer') }}</el-radio>
        </el-radio-group>
      </div>
